...
public class ViewActor extends
    ...
    public org.tapchain.core.ViewActor setSize(IPoint size) {
        _size.set(size);
        return this;
    }

    public org.tapchain.core.ViewActor setPercent(IPoint effectp) {
        _percent = effectp;
        return this;
    }

    @Override
    public org.tapchain.core.ViewActor setCenter(IPoint pos) {
        back_wp = _wp.copy();
        _wp.set(pos);// v= pos;
    ...
    public final org.tapchain.core.ViewActor addSize(WorldPoint size) {
        setSize(getRawSize().plusNew(size));
        return this;
    }

    public final org.tapchain.core.ViewActor addPercent(WorldPoint effectp) {
        setPercent(getPercent().plusNew(effectp));
        return this;
    }

	public org.tapchain.core.ViewActor setAlpha(int a) {
        _Alpha = a;
        return this;
    }

    public org.tapchain.core.ViewActor setColor(int _color) {
        color = _color;
        return this;
    }
    ...
    public class ViewActorSize extends WorldPoint implements IValue<IPoint> {
        ...
        @Override
        public boolean _valueSet(IPoint value) {
            org.tapchain.core.ViewActor.this.setSize(value);
            return true;
        }

        @Override
        public IPoint _valueGet() {
            return org.tapchain.core.ViewActor.this.getRawSize();
        }
