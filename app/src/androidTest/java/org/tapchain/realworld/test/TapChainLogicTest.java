...
//        ActorManager e = view.getSystemChain().editTap();
//        e.add(() -> 1, 0)
...
//    }
    ...
    @Test
    public void checkFibonacci() {
        view.add(TapChain.FACTORY_KEY.ALL, "Number", 100, 300);
        sleepSecond();
        Actor a;
        a = view.add(TapChain.FACTORY_KEY.ALL, "PushOut", 250, 300);
        sleepSecond();
        view.add(TapChain.FACTORY_KEY.ALL, "PassThru", 400, 400);
        sleepSecond();
        Actor b;
        b = view.add(TapChain.FACTORY_KEY.ALL, "Accumulate", 250, 500);
        sleepSecond();
